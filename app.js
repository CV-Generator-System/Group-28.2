...
function printCV() {
    // Use html2canvas to capture the generated CV section
    html2canvas(document.getElementById('preview-sc')).then(function (canvas) {
        ...
        printWindow.document.write('<img id="printed-image" src="' + imgData + '" width="100%" height="auto"/>');
        printWindow.document.write('</body></html>');
        printWindow.document.close();
        
        // Wait for the image to load before printing
        var printedImage = printWindow.document.getElementById('printed-image');
        printedImage.onload = function () {
            printWindow.print();
